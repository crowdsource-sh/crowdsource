...
lint-py:  ## run python linter with ruff
	python -m ruff check crowdsource
	python -m ruff format --check crowdsource
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix crowdsource
	python -m ruff format crowdsource
...
test-py:  ## run python tests
	python -m pytest -v crowdsource/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v crowdsource/tests --cov=crowdsource --cov-report term-missing --cov-report xml
